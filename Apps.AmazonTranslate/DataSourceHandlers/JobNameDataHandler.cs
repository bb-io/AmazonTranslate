...
public class JobNameDataHandler : BaseInvocable, IAsyncDataSourceHandler
{
    private IEnumerable<AuthenticationCredentialsProvider> Creds =>
        InvocationContext.AuthenticationCredentialsProviders;
    
    public JobNameDataHandler(InvocationContext invocationContext) : base(invocationContext)
    {
    }
